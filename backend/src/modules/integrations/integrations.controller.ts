...
export class IntegrationsController {
    ...
    @Get('sites')
    @ApiOperation({ summary: 'Get all WordPress sites for the authenticated user' })
    ...
    @ApiResponse({ status: 200, description: 'Categories refreshed successfully' })
    ...
    @ApiResponse({ status: 200, description: 'Category mappings retrieved successfully' })
