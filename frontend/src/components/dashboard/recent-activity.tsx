...
import { FileText, Rss, Plug, CreditCard, MinusCircle, Clock } from 'lucide-react'

interface Activity {
    id: string
    type: 'article_published' | 'feed_added' | 'site_connected' | 'tokens_purchased' | 'tokens_used'
    title: string
    description: string
    timestamp: Date
}
