            ...
            <div className="flex h-20 items-center justify-between px-6 md:px-10">
                ...
                <div className="flex items-center gap-6">
                    ...
                    <motion.div
                        ...
                        className="hidden sm:flex items-center gap-1.5 sm:gap-2.5 rounded-xl sm:rounded-2xl bg-gradient-to-br from-amber-400/10 to-orange-500/10 border border-amber-200/50 dark:border-amber-900/30 px-2.5 sm:px-5 py-1.5 sm:py-2.5 text-xs sm:text-sm font-black text-amber-600 shadow-sm"
                    >
                        <div className="p-1 sm:p-1.5 bg-amber-400 text-white rounded-lg shadow-inner">
                            {icons.tokens}
                        </div>
                        <div className="flex flex-col leading-tight">
                            <span className="hidden sm:inline text-[10px] uppercase tracking-widest text-amber-500/60 font-black">Kredit</span>
...
function NotificationBell() {
    ...
    return (
        <DropdownMenu open={isOpen} onOpenChange={setIsOpen}>
            <DropdownMenuTrigger asChild>
                <Button variant="ghost" className="relative h-10 w-10 sm:h-10 sm:w-10 rounded-xl hover:bg-white/40 dark:hover:bg-slate-800/40 active:bg-slate-100 dark:active:bg-slate-800">
                    {icons.bell}
                    {unreadCount > 0 && (
