...
const socialLinks = [
    {
        label: 'Twitter',
        href: 'https://twitter.com/contenly_id',
        icon: (
    ...
    {
        label: 'GitHub',
        href: 'https://github.com/creativealip-rgb/contenly',
        icon: (
            <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
    ...
    {
        label: 'LinkedIn',
        href: 'https://linkedin.com/company/contenly',
        icon: (
            <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
                ...
                <div className="grid grid-cols-2 gap-8 md:grid-cols-12 lg:gap-12">
                    ...
                    <div className="col-span-2 md:col-span-4 lg:col-span-5">
                        ...
                        <p className="text-muted-foreground max-w-xs leading-relaxed">
                            Platform otomasi konten berbasis AI. Ubah URL jadi artikel SEO, naskah video, dan carousel Instagram.
                        </p>
                        ...
                        <div className="flex items-center gap-2 mt-6">
                            {socialLinks.map((link) => (
                                <Link
                                    ...
                                    className="flex h-8 w-8 items-center justify-center rounded-md bg-slate-100 dark:bg-slate-800 text-muted-foreground hover:text-foreground hover:bg-slate-200 dark:hover:bg-slate-700 transition-all duration-200"
                    ...
                    <div className="md:col-span-2">
                        <h4 className="font-semibold text-sm mb-4 text-slate-900 dark:text-white">Produk</h4>
                    ...
                    {/* Company */}
                    <div className="md:col-span-2">
                        <h4 className="font-semibold text-sm mb-4 text-slate-900 dark:text-white">Perusahaan</h4>
                        <ul className="space-y-2.5">
