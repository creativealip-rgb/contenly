                    ...
                    <div className="grid gap-6">
                        {sites.map((site, idx) => (
                            <motion.div
                                ...
                                key={site.id}
                                className="group flex flex-col sm:flex-row sm:items-center justify-between p-4 sm:p-6 rounded-2xl sm:rounded-[2rem] bg-slate-50/50 border border-slate-100 dark:bg-slate-800/20 dark:border-slate-800/40 transition-all hover:bg-white dark:hover:bg-slate-800/40 hover:shadow-md hover:shadow-slate-200/50 dark:hover:shadow-none"
                            >
